...
public class SettingMarkupHeadElementPortlet extends GenericPortlet {
   ...
   protected void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException
   {
      ...
      w.write("<div class=\"portlet-section-header\">" + 
         encode("<base href=\"base1\" _target=\"test\">") + "</div>");
      w.write("<br\\>");
      
      w.write("<div class=\"portlet-section-header\">" + 
         encode("<base href=\"base2\" _target=\"test\">")+ "</div>");
      w.write("<br\\>");
   ...
   private void addExtraHtmlHead(RenderResponse response)
   {
